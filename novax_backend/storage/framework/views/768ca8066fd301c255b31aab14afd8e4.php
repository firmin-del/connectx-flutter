    ...
    <aside class="w-full md:w-96 flex flex-col bg-white border-r border-gray-200 flex-shrink-0">
        ...
        <div class="flex-1 overflow-y-auto" id="chatList">
            <?php $__empty_1 = true; $__currentLoopData = $chats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <a href="<?php echo e(route('chat.show', $chat->id)); ?>"
                   class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 border-b border-gray-100
                          ...
                          <?php echo e(request()->route('id') == $chat->id ? 'bg-gray-100' : ''); ?>"
                   data-name="<?php echo e(strtolower($displayName)); ?>">

                    
                    <div class="relative flex-shrink-0">
                        <div class="w-12 h-12 rounded-full flex items-center justify-center text-white font-bold
                                    <?php echo e($chat->is_group ? 'bg-purple-500' : 'bg-novax-600'); ?>">
                    ...
                    <div class="flex-1 min-w-0">
                        <div class="flex items-center justify-between">
                            <span class="font-medium text-gray-800 text-sm truncate"><?php echo e($displayName); ?></span>
                            <span class="text-xs text-gray-400 flex-shrink-0 ml-2"><?php echo e($time); ?></span>
                        </div>
                        <div class="flex items-center justify-between mt-0.5">
                            <p class="text-sm text-gray-500 truncate"><?php echo e($lastContent); ?></p>
