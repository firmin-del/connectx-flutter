<?php $__env->startSection('title', $displayName); ?>
...
<div class="h-screen flex overflow-hidden bg-gray-100">
    ...
    <aside class="hidden md:flex w-96 flex-col bg-white border-r border-gray-200 flex-shrink-0">
        <div class="flex items-center justify-between px-4 py-3 bg-novax-700">
            ...
            <div class="flex items-center gap-2">
                <a href="<?php echo e(route('contacts.index')); ?>" class="p-2 text-white hover:bg-novax-600 rounded-full transition-colors">
        ...
        <div class="flex-1 overflow-y-auto">
            <?php $__currentLoopData = $allChats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php $cName = $c->getDisplayNameFor(auth()->id()); ?>
                <a href="<?php echo e(route('chat.show', $c->id)); ?>"
                   class="flex items-center gap-3 px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors <?php echo e($c->id === $chat->id ? 'bg-gray-100' : ''); ?>">
                    <div class="w-12 h-12 rounded-full bg-novax-600 flex items-center justify-center text-white font-bold flex-shrink-0">
                        <?php echo e(strtoupper(substr($cName, 0, 1))); ?>

                    </div>
                    <div class="flex-1 min-w-0">
                        <p class="font-medium text-gray-800 text-sm truncate"><?php echo e($cName); ?></p>
                        <p class="text-xs text-gray-400 truncate"><?php echo e(Str::limit($c->lastMessage?->content ?? 'Aucun message', 35)); ?></p>
                    </div>
                </a>
    ...
    <main class="flex-1 flex flex-col min-w-0">
        ...
        <div class="flex items-center gap-3 px-4 py-3 bg-novax-700 shadow-sm flex-shrink-0">
            <a href="<?php echo e(route('chat.index')); ?>" class="md:hidden text-white mr-1">
            ...
            <div class="flex-1">
                <p class="text-white font-semibold text-sm"><?php echo e($displayName); ?></p>
                <p class="text-novax-200 text-xs" id="statusText">
                    <?php echo e($otherUser?->is_online ? 'En ligne' : ($otherUser?->last_seen ? 'Vu ' . $otherUser->last_seen->diffForHumans() : 'Hors ligne')); ?>
        ...
        <div class="flex-1 overflow-y-auto px-4 py-4 space-y-1" id="messagesContainer"
            ...
            <?php $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="flex <?php echo e($isMine ? 'justify-end' : 'justify-start'); ?> bubble-animate" data-msg-id="<?php echo e($message->id); ?>">
                    <div class="max-w-xs lg:max-w-md xl:max-w-lg">
                        ...
                        <div class="px-3 py-2 rounded-2xl shadow-sm
                            ...
                            <?php if($message->type === 'image' && $message->media_url): ?>
                                <img src="<?php echo e($message->media_url); ?>" alt="Image" class="rounded-xl max-w-full mb-1" />
                            <?php else: ?>
                                <p class="text-sm leading-relaxed break-words"><?php echo e($message->content); ?></p>
                            <?php endif; ?>

                            
                            <div class="flex items-center justify-end gap-1 mt-1">
                                <span class="text-xs <?php echo e($isMine ? 'text-novax-200' : 'text-gray-400'); ?>">
...
const CHAT_ID      = <?php echo e($chat->id); ?>;
const CURRENT_USER = {
    id:   <?php echo e(auth()->id()); ?>,
    name: "<?php echo e(auth()->user()->name); ?>"
};
const SOCKET_URL   = "<?php echo e(config('app.socket_url', 'http://localhost:3000')); ?>";
const API_TOKEN    = "<?php echo e(session('api_token')); ?>";  // Token Sanctum stocké en session
...
socket.on('user_online', (userId) => {
    if (userId == <?php echo e($otherUser?->id ?? 'null'); ?>) {
