...
<head>
    ...
    <title>@yield('title', 'NovaX') — Messagerie</title>

    {{-- TailwindCSS via CDN (remplacer par npm en production) --}}
    <script src="https://cdn.tailwindcss.com"></script>

    {{-- Configuration Tailwind : couleurs NovaX --}}
    <script>
        tailwind.config = {
            darkMode: 'class',
            theme: {
    ...
    {{-- Police Questrial depuis Google Fonts --}}
