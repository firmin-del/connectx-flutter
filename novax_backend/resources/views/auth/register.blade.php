    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm">
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-800
                               ...
                               transition-all duration-200 @error('name') border-red-400 @enderror"
                    />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input
                        ...
                        class="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-800
                               focus:outline-none focus:ring-2 focus:ring-novax-500 focus:border-transparent
                               transition-all duration-200 @error('email') border-red-400 @enderror"
                    />
                </div>
                ...
                <div class="mb-4">
                    ...
                    <div class="relative">
                        <input
                            ...
                            class="w-full px-4 py-3 border border-gray-300 rounded-xl text-gray-800
                                   focus:outline-none focus:ring-2 focus:ring-novax-500 focus:border-transparent
                                   transition-all duration-200 pr-12 @error('password') border-red-400 @enderror"
                        />
            ...
            <p class="text-center text-sm text-gray-500 mt-6">
                Déjà un compte ?
                <a href="{{ route('login') }}" class="text-novax-700 font-semibold hover:underline">
                    Se connecter
                </a>
            </p>
        </div>
